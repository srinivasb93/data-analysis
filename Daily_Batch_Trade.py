...
for stock in stock_list:
    ...
    df6 = df6.append(data.tail(20))

df5.to_csv("All_Results_" + str(dt_today) + ".csv", index=False)
df6.to_csv("All_Results50_" + str(dt_today) + ".csv", index=False)
...
ema_20_chk = ['Close_GT_20EMA','Cross_Abv_20EMA']
ema_20_stocks = df5['Symbol'][df5['EMA20_Sig'].isin(ema_20_chk)].to_list()
